  ...
  <div class="grid--span-7">
    ...
    <section class="detail-content">
      <div class="detail-content__top">
        <h1 class="detail-content__heading">{{$veterinarymedicine->vm_name}}</h1>
        
        <p class="detail-content__intro">
        Danh mục: {{$veterinarymedicine->category_vm->category_vm}}
        </p>
      </div>
      <div class="detail-content__main">
        <div class="grid_detail">
                    <figure class="figure">
                        <img src="{{$veterinarymedicine->vm_img_1}}" alt="img" class="figure__img img_detail" />
                    </figure>
                    <figure class="figure">
                        <img src="{{$veterinarymedicine->vm_img_2}}" alt="img" class="figure__img img_detail" />
                    </figure>
                    <figure class="figure">
                        <img src="{{$veterinarymedicine->vm_img_3}}" alt="img" class="figure__img img_detail" />
                    </figure>
                </div>

        {!! $veterinarymedicine->vm_description !!}
    ...
    <br>
      <div>
        ...
        <div class="detail-content__top"><strong>Danh sách các bệnh : </strong>
            @foreach($veterinarymedicine->soa as $key => $data)
    ...
    <section class="detail-other">
      ...
      <div class="article-list">
        @foreach($listveterinarymedicine as $key => $data)
        <article class="article article--medium">
          ...
          <div class="article__info">
            <h2 class="article__heading">
              <a href="/veterinary-medicine/detail/{{$data->vm_id}}" class="article__link title-cut-2">{{$data->vm_name}}</a>
            </h2>
            <div class="article__category">
                <p class="detail-content__intro">
            {{$data->category_vm->category_vm}}
            </p>
            </div>
