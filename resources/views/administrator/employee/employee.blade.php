              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input disabled required value="{{$data['admin_phone']}}" name= "phone" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Địa chỉ</label>
                    <input disabled required value="{{$data['admin_address']}}" name= "address" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Ngày sinh</label>
                    <input disabled required value="{{$data['admin_birthday']}}" name= "birthday" type="date" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Avatar</label>
                    <input disabled required value="{{$data['admin_avatar']}}" name= "avatar" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                  </div>
