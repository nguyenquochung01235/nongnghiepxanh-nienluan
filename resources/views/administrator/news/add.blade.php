    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- Form Add Department -->
                <form method="post" action="/administrator/news/add/create">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input required value="{{old('newTitle')}}" type="text" class="form-control" id="newTitle" name="newTitle" placeholder="Nhập Tiêu Đề Tin Tức">
                        </div>

                        <div class="form-group">
                            
                            <img id="img_news" style="max-width: 350px;" src="" alt="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" hidden id="news_img" name="news_img" value="">
                        </div>
